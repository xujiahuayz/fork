...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "fork_env.integrationCy",
        "sources": [
            "/Users/jx/projects/fork/fork_env/integrationCy.pyx"
        ]
    },
    "module_name": "fork_env.integrationCy"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fork_env__integrationCy
#define __PYX_HAVE_API__fork_env__integrationCy
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdio.h>
...
/* Module declarations from "fork_env.integrationCy" */
static double __pyx_v_8fork_env_13integrationCy_SQRRT2PI;
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "fork_env.integrationCy"
extern int __pyx_module_is_main_fork_env__integrationCy;
int __pyx_module_is_main_fork_env__integrationCy = 0;

/* Implementation of "fork_env.integrationCy" */
...
static const char __pyx_k_quad_vec[] = "quad_vec";
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_n_s_quad_vec);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_n_s_quad_vec);
...
#define __pyx_n_s_quad_vec __pyx_mstate_global->__pyx_n_s_quad_vec
...
static double __pyx_f_8fork_env_13integrationCy_pdf_log_normal(double __pyx_v_lam, double __pyx_v_sum_lambda, double __pyx_v_n, double __pyx_v_sigma) {
  double __pyx_r;
  double __pyx_t_1;
  double __pyx_t_2;
  double __pyx_t_3;
 ...
 * 
 */
  __pyx_t_1 = (__pyx_v_lam * __pyx_v_n);
  if (unlikely(__pyx_v_sum_lambda == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(1, 15, __pyx_L1_error)
  }
  __pyx_t_2 = pow(((pow(__pyx_v_sigma, 2.0) / 2.0) + log((__pyx_t_1 / __pyx_v_sum_lambda))), 2.0);
  __pyx_t_1 = (2.0 * pow(__pyx_v_sigma, 2.0));
  if (unlikely(__pyx_t_1 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(1, 15, __pyx_L1_error)
  }

  /* "fork_env/integrationCy.pyx":14
 *     pdf of the log normal distribution where mean = np.log(sum_lambda / n) - np.square(sigma) / 2 and sigma = sigma
 *     """
 *     return 1 / (lam * sigma * SQRRT2PI * exp(             # <<<<<<<<<<<<<<
 *         ((pow(sigma,2) / 2 + log(lam*n/sum_lambda)) ** 2) / (2 * pow(sigma,2))
 *     ))
 */
  __pyx_t_3 = (((__pyx_v_lam * __pyx_v_sigma) * __pyx_v_8fork_env_13integrationCy_SQRRT2PI) * exp((__pyx_t_2 / __pyx_t_1)));
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("fork_env.integrationCy.pdf_log_normal", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}

/* "fork_env/integrationCy.pyx":20
 * 
 * 
...
static double __pyx_f_8fork_env_13integrationCy_pdf_lomax(double __pyx_v_lam, double __pyx_v_sum_lambda, double __pyx_v_n, double __pyx_v_c) {
  double __pyx_r;
  double __pyx_t_1;
  double __pyx_t_2;
  double __pyx_t_3;
 ...
 */
  __pyx_t_1 = (__pyx_v_n * __pyx_v_c);

  /* "fork_env/integrationCy.pyx":27
 *         n
 *         * c
 *         / pow(1 + n * lam / (sum_lambda * (c - 1)), c)             # <<<<<<<<<<<<<<
 *         / (sum_lambda * (c - 1) + n * lam)
 *     )
 */
  __pyx_t_2 = (__pyx_v_n * __pyx_v_lam);
  __pyx_t_3 = (__pyx_v_sum_lambda * (__pyx_v_c - 1.0));
  if (unlikely(__pyx_t_3 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(1, 27, __pyx_L1_error)
  }
  __pyx_t_4 = pow((1.0 + (__pyx_t_2 / __pyx_t_3)), __pyx_v_c);
 ...
 * 
 */
  __pyx_t_4 = ((__pyx_v_sum_lambda * (__pyx_v_c - 1.0)) + (__pyx_v_n * __pyx_v_lam));
  if (unlikely(__pyx_t_4 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("fork_env.integrationCy.pdf_lomax", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_n_s_quad_vec, __pyx_k_quad_vec, sizeof(__pyx_k_quad_vec), 0, 0, 1, 1},
...
static int __pyx_pymod_exec_integrationCy(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_integrationCy},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initintegrationCy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initintegrationCy(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_integrationCy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_integrationCy(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_integrationCy(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'integrationCy' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("integrationCy", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  if (unlikely(!__pyx_m)) __PYX_ERR(1, 1, __pyx_L1_error)
  #elif CYTHON_USE_MODULE_STATE
  __pyx_t_1 = PyModule_Create(&__pyx_moduledef); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 1, __pyx_L1_error)
  {
    int add_module_result = PyState_AddModule(__pyx_t_1, &__pyx_moduledef);
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "integrationCy" pseudovariable */
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_integrationCy(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main_fork_env__integrationCy) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(1, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fork_env.integrationCy")) {
      if (unlikely((PyDict_SetItemString(modules, "fork_env.integrationCy", __pyx_m) < 0))) __PYX_ERR(1, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__Pyx_PyList_SET_ITEM(__pyx_t_2, 0, __pyx_n_s_lru_cache)) __PYX_ERR(1, 1, __pyx_L1_error);
  __pyx_t_3 = __Pyx_Import(__pyx_n_s_functools, __pyx_t_2, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_ImportFrom(__pyx_t_3, __pyx_n_s_lru_cache); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_lru_cache, __pyx_t_2) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "fork_env/integrationCy.pyx":3
 * from functools import lru_cache
 * from libc.math cimport exp, log, sqrt, pow
 * import numpy as np             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_3 = PyList_New(2); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_INCREF(__pyx_n_s_dblquad);
  __Pyx_GIVEREF(__pyx_n_s_dblquad);
  if (__Pyx_PyList_SET_ITEM(__pyx_t_3, 0, __pyx_n_s_dblquad)) __PYX_ERR(1, 4, __pyx_L1_error);
  __Pyx_INCREF(__pyx_n_s_quad_vec);
  __Pyx_GIVEREF(__pyx_n_s_quad_vec);
  if (__Pyx_PyList_SET_ITEM(__pyx_t_3, 1, __pyx_n_s_quad_vec)) __PYX_ERR(1, 4, __pyx_L1_error);
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_scipy_integrate, __pyx_t_3, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_dblquad); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_dblquad, __pyx_t_3) < 0) __PYX_ERR(1, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_quad_vec); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_quad_vec, __pyx_t_3) < 0) __PYX_ERR(1, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "fork_env/integrationCy.pyx":8
 * 
 * # Define constants
 * cdef double SQRRT2PI = sqrt(2 * np.pi)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_pi); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_MultiplyCObj(__pyx_int_2, __pyx_t_3, 2, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_4 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_4 == (double)-1) && PyErr_Occurred())) __PYX_ERR(1, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_8fork_env_13integrationCy_SQRRT2PI = sqrt(__pyx_t_4);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init fork_env.integrationCy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init fork_env.integrationCy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
