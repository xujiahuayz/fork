...
BLOCK_WINDOW_MULTIPLIER = 1
BLOCK_WINDOW = int(2_016 * BLOCK_WINDOW_MULTIPLIER)  # 2016 blocks - difficulty adjustment interval
FIRST_START_BLOCK = int(180 / BLOCK_WINDOW_MULTIPLIER * BLOCK_WINDOW) # 500_000
